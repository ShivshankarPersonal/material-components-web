...
<div class="mdc-select">
  <div class="mdc-select__anchor demo-width-class">
    ...
    <input type="text" disabled class="mdc-select__selected-text">
...
<div class="mdc-select">
  <div class="mdc-select__anchor"
    ...
    <span class="mdc-select__ripple"></span>
    <input type="text" disabled id="demo-selected-text" class="mdc-select__selected-text" value="Vegetables">
    <i class="mdc-select__dropdown-icon"></i>
...
<div class="mdc-select mdc-select--outlined">
  <div class="mdc-select__anchor" aria-labelledby="outlined-select-label">
    <span class="mdc-select__ripple"></span>
    <input type="text" disabled id="demo-selected-text" class="mdc-select__selected-text">
    <i class="mdc-select__dropdown-icon"></i>
...
<div class="mdc-select">
  <div class="mdc-select__anchor demo-width-class">
    <span class="mdc-select__ripple"></span>
    <input type="text" disabled class="mdc-select__selected-text" value="Vegetables">
    <i class="mdc-select__dropdown-icon"></i>
